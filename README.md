<img width="1744" height="905" alt="S" src="https://github.com/user-attachments/assets/b12746e5-fb64-41a4-b343-5ec77166cff6" />
...
│   ├── senet.js             # WASM bindings                    (Backend)  (Source / Module)
│   ├── senet_bg.wasm        # Compiled WebAssembly             (Backend)  (Source / Library)
│   ├── senet.d.ts           # TypeScript definitions           (Backend)  (Source / Module)
│   ├── senet_bg.wasm.d.ts   # WASM TypeScript definitions      (Backend)  (Source / Module)
